...
new Vue({
  ...
  data: function () {
    return {
      lnbitsServiceFee: null,
      lnbitsServiceFeeMax: null,
  ...
  methods: {
    ...
    decodeRequest: function () {
      ...
      let feeRate = this.lnbitsServiceFee
      let maxFee = this.lnbitsServiceFeeMax
    ...
    updatePaymentBalance(totalSatParam) {
      ...
      LNbits.api
        ...
        .then(response => {
          // 비트코인 가격 조회 (UPBIT-KRW)
          if (this.g.wallet.currency === 'KRW') {
            this.bitcoinPriceKrw = response.data['BTCKRW']
          }
